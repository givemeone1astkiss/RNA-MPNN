...
def predict(model: RNAModel, data_path=COMPETITION_DATA, output_path=COMPETITION_OUT):
    ...
    data = torch.utils.data.DataLoader(predict_dataset, batch_size=32, num_workers=19, shuffle=False, persistent_workers=True, collate_fn=featurize)
